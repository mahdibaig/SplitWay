    ...
    var body: some View {
        List {
            Section {
                ...
                if proxyConfigured {
                    Text("Your question and a snapshot of household data are sent to the Splitway assistant service to generate answers. Conversation history is stored on this device only.")
                } else {
